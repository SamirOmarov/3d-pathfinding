...
export default {
	...
	methods: {
		init() {
			...
			this.scene.fog = new THREE.Fog(0x001f3f, 0, 750);
			...
			var gridHelper = new THREE.GridHelper(size, divisions, 0x001f3f, 0x001f3f);
			...
			this.wallGeomtery = new THREE.CylinderBufferGeometry(
				this.nodeDimensions.width/2,
        this.nodeDimensions.width/2,
				wallHeight/2,
        20
			);
			...
			var uniforms = {
				...
				bottomColor: { value: new THREE.Color(0x001f3f) },
				offset: { value: 33 },
				exponent: { value: 0.6 },
			};
